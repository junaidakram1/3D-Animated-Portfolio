  ...
  return (
    <>
      <div className="desktop-only-message">
        Note: Due to 3D models rendering and resource usage, this portfolio site
        is currently best experienced on a desktop. <br />
        <br />
        Please visit us on a desktop or laptop for the full experience. <br />
        <br />
      ...
      <div className="hero">
        ...
        <div className="hSection right">
          ...
          >
            ...
            <motion.a
              variants={followVariants}
              href="https://github.com/junaidakram1"
              target="_blank"
            >
            ...
            >
              <div className="followText">CONNECT</div>
            </motion.div>
          </motion.div>
          {/* BUBBLE */}
          <Speech />
